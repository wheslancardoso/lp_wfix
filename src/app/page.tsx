            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <AnimateIn delay={0.2}>
                <a
                  ...
                  target="_blank"
                  className="card-3d group bg-white/[0.03] backdrop-blur-xl border border-white/10 hover:border-pink-500/30 p-8 rounded-[30px] flex flex-col items-center text-center"
                >
                  <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-6 group-hover:bg-gradient-to-tr group-hover:from-yellow-400/20 group-hover:via-pink-500/20 group-hover:to-purple-600/20 transition-all duration-500 animate-float-subtle" style={{ animationDelay: '1s' }}>
                  ...
                  <span className="bg-white text-black text-[9px] font-black px-6 py-2 rounded-full uppercase tracking-widest group-hover:bg-gradient-to-r group-hover:from-pink-500 group-hover:to-purple-600 group-hover:text-white transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(236,72,153,0.4)]">
                    Seguir Perfil
                  </span>
                </a>
              </AnimateIn>
