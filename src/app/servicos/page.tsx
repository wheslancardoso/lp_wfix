...
export function generateMetadata() {
    return {
        title: 'Soluções em Hardware e Performance | WFIX Tech',
        description: 'Especialistas em infraestrutura de hardware corporativo e pessoal. Performance de notebooks, workstations e impressoras.',
        robots: {
            index: false,
            follow: false,
            googleBot: {
...
export default function ServicesPage() {
    const { whatsappNumber, brandName } = getTenantData()
                ...
                <div className="text-center mb-16 relative">
                    ...
                    <AnimateIn>
                        <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 relative z-10">
                            Soluções em Hardware e <span className="text-primary">Performance</span>
                        </h1>
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed relative z-10">
                            Não é apenas trocar peças. É estruturar a performance do seu equipamento, prevenindo paradas inesperadas e estendendo a vida útil.
                        </p>
                    </AnimateIn>
                </div>
                    ...
                    <AnimateIn delay={0.2}>
                        <div className="grid md:grid-cols-3 gap-8 relative">
                            ...
                            <div className="relative pt-8 text-center bg-slate-950 z-10">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed px-4">
                                    Antes de te entregar, validamos tudo em ambiente controlado. Áudio, vídeo, refrigeração e estabilidade. Você recebe pronto para uso intenso.
                                </p>
                            </div>
                        </div>
                    </AnimateIn>
                        ...
                        <section id="notebooks" className="scroll-mt-28 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                            <div className="order-2 md:order-1 relative z-10">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-md">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            ...
                                            <span><strong>Recuperação de Estruturas:</strong> Restauração completa de carcaças e dobradiças.</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" />
                                            <span><strong>Otimização Térmica:</strong> Higienização interna de componentes e aplicação de compostos de alta dissipação.</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" />
                                            <span><strong>Substituição de Hardware:</strong> Teclados, baterias e telas.</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" />
                                            <span><strong>Upgrades de Performance:</strong> Transição para SSD e expansão de Memória RAM.</span>
                                        </li>
                                    </ul>
                                </div>
                                <Button asChild className="w-full md:w-auto bg-primary hover:bg-primary/90 text-slate-950 font-bold px-8 rounded-full h-12 cursor-pointer relative z-20 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-300">
                                    <Link href={whatsappLink} target="_blank">
                                        Solicitar Avaliação de Hardware
                                    </Link>
                                </Button>
                            </div>
                            <div className="order-1 md:order-2 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl border border-white/5 aspect-square flex items-center justify-center relative overflow-hidden group shadow-2xl">
                                <Image
                                    ...
                                    alt="Estrutura avançada para análise de notebook"
                                    fill
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-md">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            ...
                                            <span><strong>Montagem Especializada (Workstation/Gamer):</strong> Projetos e montagens focadas em alta demanda.</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" />
                                        ...
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" />
                                            <span><strong>Ganho de Performance:</strong> Transição para SSD NVMe e expansão de GPU/RAM.</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-blue-500 shrink-0" />
                                            <span><strong>Reestruturação Física:</strong> Refatoração interna e organização de cabeamento (cable management).</span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <AnimateIn direction="left">
                        <section id="impressoras" className="scroll-mt-28 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                            <div className="order-2 md:order-1 relative z-10">
                                ...
                                <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Problemas na sua impressora corporativa?</h2>
                                <p className="text-slate-400 text-lg mb-6 leading-relaxed">
                                    Atuamos em intervenções estruturais em cabeçotes, tracionadores de papel e integração com redes Wi-Fi (Epson, Canon, HP).
                                </p>
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-md">
                                    <h4 className="font-bold text-slate-200 mb-4">Principais intervenções:</h4>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                        ...
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-pink-500 shrink-0" />
                                            <span><strong>Sistemas Mecânicos:</strong> Correção no sistema de tração (atolamentos contínuos).</span>
                                        </li>
                                        <li className="flex gap-3 text-slate-300 text-sm">
                                            <CheckCircle2 className="w-5 h-5 text-pink-500 shrink-0" />
                                            <span><strong>Integração Lógica:</strong> Mapeamento do dispostivo na rede corporativa e Wi-Fi local.</span>
                                        </li>
                                    </ul>
                                </div>
                                <Button asChild className="w-full md:w-auto bg-pink-500 hover:bg-pink-600 text-white font-bold px-8 rounded-full border-0 h-12 cursor-pointer relative z-20 shadow-lg shadow-pink-500/20 hover:shadow-pink-500/40 transition-all duration-300">
                                    <Link href={whatsappLink} target="_blank">
                                        Avaliar Impressora em nossa Estrutura
                                    </Link>
                                </Button>
                            </div>
                            <div className="order-1 md:order-2 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl border border-white/5 aspect-square flex items-center justify-center relative overflow-hidden group shadow-2xl">
